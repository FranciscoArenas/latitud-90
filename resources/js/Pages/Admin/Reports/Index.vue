    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
              ...
              <div class="bg-blue-50 p-4 rounded-lg">
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-xl font-bold text-blue-600">${{ reportData.totalRevenue.toLocaleString() }}</p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-green-50 p-4 rounded-lg">
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-xl font-bold text-green-600">{{ reportData.totalReservations }}</p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-yellow-50 p-4 rounded-lg">
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-xl font-bold text-yellow-600">{{ reportData.conversionRate }}%</p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-purple-50 p-4 rounded-lg">
                <div class="flex items-center">
                  ...
                  <div>
                    ...
                    <p class="text-xl font-bold text-purple-600">${{ reportData.averageOrderValue.toLocaleString() }}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <div class="h-64 flex items-center justify-center bg-gray-50 rounded">
              <p class="text-gray-500">Gráfico de ventas (Chart.js se implementaría aquí)</p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
              <h3 class="text-lg font-semibold mb-4">Programas Más Populares</h3>
              
              <div class="space-y-3">
                <div v-for="(program, index) in reportData.popularPrograms" :key="program.id" class="flex items-center justify-between p-3 bg-gray-50 rounded">
                  <div class="flex items-center">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-500">{{ program.reservations_count }} reservas</p>
                    </div>
                  </div>
                  <div class="text-right">
                    <p class="font-bold text-gray-900">${{ program.total_revenue.toLocaleString() }}</p>
          ...
          <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
              ...
              <div class="space-y-3">
                <div v-for="payment in reportData.paymentMethods" :key="payment.gateway" class="flex items-center justify-between p-3 bg-gray-50 rounded">
                  <div class="flex items-center">
                    <span :class="getGatewayClass(payment.gateway)" class="px-2 py-1 text-xs font-semibold rounded-full mr-3">
                      {{ payment.gateway.toUpperCase() }}
                    </span>
                    <span class="font-medium">{{ payment.count }} transacciones</span>
                  </div>
                  <div class="text-right">
                    <p class="font-bold">${{ payment.total.toLocaleString() }}</p>
                    <p class="text-sm text-gray-500">{{ payment.percentage }}%</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <div class="flex space-x-4">
              ...
              >
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                </svg>
                Exportar CSV
              </button>
            </div>
