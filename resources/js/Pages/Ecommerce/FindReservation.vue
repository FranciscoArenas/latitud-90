        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    Encuentra tu reserva usando tu número de reserva y email, o busca por tus datos personales.
                </p>
            </div>
                            ...
                            <div class="flex-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="font-medium text-gray-900">{{ reservation.program.duration_days }} {{ reservation.program.duration_days === 1 ? 'día' : 'días' }}</p>
                                    </div>
                                </div>
            ...
            <div v-else-if="hasSearched && searchResults.length === 0" class="text-center py-12">
                ...
                <p class="text-gray-600 mb-4">Verifica que la información ingresada sea correcta.</p>
                <button 
                    @click="resetSearch"
            ...
            <div class="mt-12 bg-blue-50 rounded-lg p-6">
                <h3 class="text-lg font-bold text-blue-900 mb-4">¿No encuentras tu reserva?</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-800">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <p>📞 +56 2 2233 4455</p>
                            <p>💬 <a href="https://wa.me/56912345678" class="hover:underline">WhatsApp</a></p>
                        </div>
                    </div>
                </div>
            </div>
