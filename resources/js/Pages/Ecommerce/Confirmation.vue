        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-bold text-gray-900 mb-2">
                    {{ reservationStatus === 'confirmed' ? '¡Reserva Confirmada!' : '¡Reserva Recibida!' }}
                </h1>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                    ...
                    <span v-else>
                        Tu reserva está siendo procesada. Te mantendremos informado sobre el estado de tu reserva.
                    </span>
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">{{ program.duration_days }} {{ program.duration_days === 1 ? 'día' : 'días' }}</p>
                                </div>
                            </div>
                ...
                <div class="bg-white rounded-lg shadow-sm">
                    <div class="p-6">
                        <h2 class="text-xl font-bold text-gray-900 mb-4">Información del Pasajero</h2>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Recibirás un email de confirmación con todos los detalles en los próximos minutos.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600">Te enviaremos la documentación necesaria y lista de equipaje recomendado.</p>
                                </div>
                            </div>
            ...
            <div class="mt-12 bg-indigo-50 rounded-lg p-6 text-center">
                <h3 class="text-lg font-bold text-indigo-900 mb-2">¿Necesitas Ayuda?</h3>
                <p class="text-indigo-700 mb-4">Nuestro equipo está disponible para ayudarte con cualquier consulta.</p>
