    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="p-6">
                    <div class="flex items-start space-x-6">
                        <div class="w-32 h-32 bg-gray-200 rounded-lg flex-shrink-0">
                            <img v-if="program.image_url" :src="program.image_url" :alt="program.name" class="w-full h-full object-cover rounded-lg">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm text-gray-500">
                                <div>
                                    <span class="font-medium">Destino:</span> {{ program.destination }}
                                </div>
                                <div>
                                    <span class="font-medium">Duración:</span> {{ program.duration_days }} {{ program.duration_days === 1 ? 'día' : 'días' }}
                                </div>
                                <div>
                                    <span class="font-medium">Salida:</span> {{ formatDate(program.departure_date) }}
                                </div>
                                <div>
                                    <span class="font-medium">Precio:</span> <span class="text-2xl font-bold text-indigo-600">${{ formatPrice(program.base_price) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div class="p-6">
                    <h2 class="text-2xl font-bold text-gray-900 mb-6">Datos del Pasajero</h2>
                    ...
                    <form @submit.prevent="submitReservation">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                />
                                <div v-if="errors.birth_date" class="mt-1 text-sm text-red-600">{{ errors.birth_date }}</div>
                            </div>
                            ...
                            <div>
                                ...
                                <div v-if="errors.document_type" class="mt-1 text-sm text-red-600">{{ errors.document_type }}</div>
                            </div>
                            ...
                            <div>
                                ...
                                />
                                <div v-if="errors.document_number" class="mt-1 text-sm text-red-600">{{ errors.document_number }}</div>
                            </div>

                            <!-- Información de Contacto -->
                            <div class="md:col-span-2">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 mt-6">Información de Contacto</h3>
                            </div>
                            ...
                            <div class="md:col-span-2">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 mt-6">Contacto de Emergencia</h3>
                            </div>

                            <div>
                                <label for="emergency_contact_name" class="block text-sm font-medium text-gray-700 mb-2">Nombre Contacto Emergencia *</label>
                                <input 
                                ...
                                />
                                <div v-if="errors.emergency_contact_name" class="mt-1 text-sm text-red-600">{{ errors.emergency_contact_name }}</div>
                            </div>

                            <div>
                                <label for="emergency_contact_phone" class="block text-sm font-medium text-gray-700 mb-2">Teléfono Contacto Emergencia *</label>
                                <input 
                                ...
                                />
                                <div v-if="errors.emergency_contact_phone" class="mt-1 text-sm text-red-600">{{ errors.emergency_contact_phone }}</div>
                            </div>

                            <!-- Información Adicional -->
                            <div class="md:col-span-2">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4 mt-6">Información Adicional</h3>
                            </div>

                            <div>
                                <label for="dietary_restrictions" class="block text-sm font-medium text-gray-700 mb-2">Restricciones Alimentarias</label>
                                <textarea 
                                ...
                                ></textarea>
                                <div v-if="errors.dietary_restrictions" class="mt-1 text-sm text-red-600">{{ errors.dietary_restrictions }}</div>
                            </div>

                            <div>
                                <label for="medical_conditions" class="block text-sm font-medium text-gray-700 mb-2">Condiciones Médicas</label>
                                <textarea 
                                ...
                                ></textarea>
                                <div v-if="errors.medical_conditions" class="mt-1 text-sm text-red-600">{{ errors.medical_conditions }}</div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8">
                            ...
                            <div v-if="errors.accept_terms" class="mt-1 text-sm text-red-600">{{ errors.accept_terms }}</div>
                        </div>

                        <!-- Submit Button -->
                        <div class="mt-8 flex justify-end space-x-4">
                            <Link :href="route('ecommerce.show', program.id)" class="px-6 py-3 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition duration-200">
                                Volver
                            </Link>
                            <button 
                                type="submit" 
